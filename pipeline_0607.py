...
YEARS = []
for y in _RAW_YEARS:
    _target_sub = os.path.join(y, r"testorror\測量坐標讀數")
...
# GLOBAL_ALL_RESULTS_PATH  = r"D:\Chiayi_AI\11test\桿件-桿件埋深-照片all_results.json"
# GLOBAL_REPEAT_IMAGE_PATH = r"D:\Chiayi_AI\11test\桿件-桿件埋深-照片repeat_images.json"
...
# COORD_YOLO_MODEL_PATH = r"D:\Chiayi_AI\YOLO_dataset\判斷格式分類best.pt"  # 訓練好的座標格式分類模型
